...
Vi lascio allegato anche uno screen di esempio. -->
...
<body>
    <header>
        <div>
            <a href="www.google.com">
                <img src="https://www.progettoitalianews.net/news/wp-content/uploads/2019/08/google2.0.0.jpg"/>
            </a>
    ...
    <nav>
        <ul>
            <li tabindex="0">Introduzione</li>
            <li tabindex="0">Norma sulla Privacy</li>
            <li tabindex="0">Termini di Servizio</li>
            <li tabindex="0">Tecnologie</li>
            <li tabindex="0">Domande Frequenti</li>
        </ul>
    </nav>

    <main>
        <?php 
        foreach($DomandeFrequenti as $dettaglio) { ?>
            <h2> <?php echo $dettaglio['question'] ?> </h2>
            <p><?php echo $dettaglio['answer'] ?></p>
        <?php } ?>
